...
class ThirdPersonCamera {
  ...
  _CalculateIdealOffset() {
    ...
    if (toggle == true)
      ...
      idealOffset = new THREE.Vector3(0, 10, 5);
...
class ThirdPersonCameraDemo {
  ...
  _Initialize() {
    ...
    l.load('./LightningStruckDemo_Regular.json',function(font){
    ...
    loaderr.load('./resources/anime_classroom.glb', (gltf) => {
      gltf.scene.position.set(15, 0, 90);
